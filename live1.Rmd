...
write_lines(modelo, path = "modelo1.bugs")
...
saida1.r2jags
saida1.r2jags %>% 
  MCMCvis::MCMCplot(params = c("pct.controle", "pct.tratamento"))
saida1.r2jags %>% 
  MCMCvis::MCMCtrace(
...
saida1.r2jags %>% 
  MCMCvis::MCMCplot(params = c("delta.p", "delta.logit.p", "delta.pct"))
saida1.r2jags %>% 
  MCMCvis::MCMCtrace(
    params = c("delta.p", "delta.logit.p", "delta.pct"), 
    type = "density"
  )
bayesplot::mcmc_hex(saida1.r2jags, pars = c("pct.controle", "pct.tratamento"))
```
